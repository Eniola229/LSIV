 ...
 @include('components.admin-sidenav')
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="d-flex justify-content-between align-items-center px-4">
        <h4 class="mb-0">Case Study</h4>
        <a href="{{ url('/admin/add-blog') }}">
        <button class="btn btn-primary">Add New Case Study</button>
      </a>
    </div>
    @if ($errors->any())
  <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
   ...
   @endif
    ...
    @endif
    <div class="row mt-4">
            <div class="col-lg col-md-6 mt-4 mb-4 d-flex">
               @foreach($blogs as $blog)
                <a href="{{ route('admin.blog.view', $blog->id) }}">
                <div class="card col-md-12 z-index-2" style="width: 500px">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                        <div class="shadow-primary border-radius-lg py-3 pe-1" style="background-image: url('{{ asset($blog->cover_image) }}'); height: 300px; background-size: cover; background-position: center;">
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="mb-0 text-sm"> Uploaded {{ $blog->created_at->format('F j, Y') }} </p>
                        </div>
                    </div>
                </div>
                 </a>
