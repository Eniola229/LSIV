      ...
      <section class="py-16 rounded bg-accentTextLight">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              <h1
                class="md:text-5xl lg:text-[3.5rem] capitalize text-3xl mb-2 font-playfair font-semibold leading-normal"
              >
            ...
            <div class="lg:w-2/3 lg:pl-10 lg:ml-52">
              ...
              <p
                class="text-primary leading-[2.1675rem] mb-6 text-xl font-semibold"
              >
          ...
          <div class="my-6 w-full">
            ...
            >
              <!-- disscuss 1 -->
              <div
                class="disscuss-item border-b bg-secondary p-6 rounded-lg transition-[all] duration-700"
              >
                <div
                  class="disscuss-head text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
                  <h3
                    class="capitalize font-playfair font-[500] md:w-4/5 text-left md:leading-[2.3325rem] text-xl md:text-[1.75rem]"
                  >
                    Philanthropy Organizations & NGOs/Non-Profits
                  </h3>
                  <span class="icon text-4xl font-semibold font-sans">+</span>
                </div>
                <div
                  class="faq-answer hidden mt-4 text-accentTextDark font-normal leading-[2.1675rem] mb-2 text-lg"
                >
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Quaerat suscipit quas fugit voluptatem recusandae possimus
                  velit natus vitae eveniet quisquam ratione ducimus, sit alias
                  maiores necessitatibus, voluptatum numquam illo officia beatae
                  cupiditate ex sint! Ab, repellendus explicabo voluptas enim
                  soluta tenetur doloremque repellat necessitatibus, eligendi
                  illo tempora sed incidunt officiis.
                </div>
              </div>
              <!-- disscuss 2 -->
              <div
                class="disscuss-item border-b bg-[#FFC6DB] p-6 rounded-lg transition-[all] duration-700"
              >
                <div
                  class="disscuss-head text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
              ...
              <!-- disscuss 3 -->
              <div
                class="disscuss-item border-b bg-[#F1DAB7] p-6 rounded-lg transition-[all] duration-700"
              >
                <div
                  class="disscuss-head text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
              ...
              <!-- disscuss 4 -->
              <div
                class="disscuss-item border-b bg-[#DDC2FF] p-6 rounded-lg transition-[all] duration-700"
              >
                <div
                  class="disscuss-head text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
