    ...
    <main>
      ...
      <section class="bg-white py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex gap-3 items-center mb-2">
            Our initiative >
            <p class="text-primary capitalize">MyBodyIsMine</p>
          </div>
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              ...
              >
                Empowering young people through sexuality education:
                <span class="text-primary"> MyBodyIsMine initiative</span>
              </h1>
            </div>
            <!-- Text Section -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <div class="mt-8">
            ...
            <ul class="custom-bullet-list">
                ...
                <strong>Reaching Thousands:</strong> MyBodyIsMine has
                successfully trained over 3,000 young people across various
                secondary schools in Nigeria. We are also the official sex
                education provider for juvenile correctional centres in Lagos
                State.
              </li>
                    <li class="flex flex-wrap gap-2">
                       <span class="mt-1">
                ...
                <strong>Global Recognition:</strong> Our educational posters,
                available in four languages, have been used by over 10 million
                people across Africa, North America, Europe, and Asia.
              </li>
                    <li class="flex flex-wrap gap-2">
                       <span class="mt-1">
                             <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <strong>Shaping the Future:</strong> We collaborate with leading
                organizations like amaze to develop culturally relevant SRH
                education materials tailored to the realities of young people in
                Africa.
              </li>
            </ul>
            <div class=" mt-4 text-base flex flex-col gap-5">
              <p>
      ...
      <section class="flex flex-col items-center bg-miscellanous py-16">
        <div class="text-center w-full h-96 space-y-6">
          <h2
            class="text-3xl md:text-5xl lg:text-6xl font-[500] lg:leading-[5.625rem] mb-4 font-playfair w-4/5 mx-auto"
          >
            Learn more about how you can partner with MyBodyIsMine to empower
