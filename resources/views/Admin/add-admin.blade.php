                    ...
                    <div class="card-body">
                      <form action="{{ route('admin.postRegistration') }}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control border" id="name" name="name" placeholder="Enter admin name" required>
                        </div>

                        <!-- Email Field -->
                        <div class="mb-3">
                          <label for="email" class="form-label">Email</label>
                          <input type="email" class="form-control border" id="email" name="email" placeholder="Enter admin email" required>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" class="form-control border" id="password" name="password" placeholder="Enter admin password" required>
                        </div>

                        <!-- Submit Button -->
                        <div class="d-grid gap-2">
                          <button type="submit" class="btn text-white" style="background: darkorange;">Add Admin</button>
                        </div>
                      </form>
                    </div>
                  </div>
