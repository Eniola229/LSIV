      ...
      <section class="bg-white py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex gap-3 items-center mb-2">
            Our initiative >
            <p class="text-primary capitalize">No Day Off</p>
          </div>
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              <h1
                class="md:text-5xl lg:text-[3.5rem] text-3xl mb-6 font-playfair font-semibold leading-normal"
              >
                Keeping Girls in School:
                <span class="text-primary"> The No Day Off Initiative </span>
              </h1>
            </div>
            <!-- Text Section -->
...
<!--           <div class="my-6 w-full h-96">
      ...
      <section class="bg-secondary py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <li class="flex flex-wrap gap-2">
              ...
              <strong>Reusable Pad Distribution:</strong> We equip girls with
              washable and reusable sanitary pads at the beginning of each
              school year, eliminating the financial burden of disposable
              products and ensuring access to period care throughout the year.
            </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <strong>Menstrual Hygiene Education:</strong> We go beyond
              distribution by offering comprehensive workshops on:
              <ul class="list-disc pl-5 ml-6">
                <li>
                  Making reusable sanitary pads (empowering self-sufficiency)
                </li>
                <li>
                  Proper menstrual hygiene practices (promoting health and
                  well-being)
                </li>
              </ul>
            </li>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Empowering Young Women:</strong> The No Day Off
                Initiative has trained over 250 girls and adolescents on
                menstrual hygiene and the creation of reusable pads. This
                knowledge empowers them to confidently manage their periods and
                avoid missing school due to period poverty.
              </li>
              <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <strong>Dignity & Education:</strong> By addressing period
                poverty, we ensure girls can attend school consistently and
                participate fully in their education, fostering a brighter
      ...
      <section class="flex flex-col items-center bg-miscellanous py-16">
        <div class="text-center w-full h-96 space-y-6">
          <h2
            class="text-3xl md:text-5xl lg:text-6xl font-[500] lg:leading-[5rem] mb-4 font-playfair w-1/2 mx-auto"
          >
