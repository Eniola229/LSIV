    ...
    <main>
      ...
      <section class="bg-white py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex gap-3 items-center mb-2">
            Our initiative >
            <p class="text-primary capitalize">The Conversation</p>
          </div>
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              ...
              >
                Igniting Potential:
                <span class="text-primary"> The Conversation </span>
              </h1>
            </div>
            <!-- Text Section -->
            <div class="lg:w-2/3 lg:pl-10 lg:ml-52">
              ...
              >
                ...
                <strong> The Conversation </strong> fosters meaningful dialogue
      ...
      <section class="bg-secondary py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <li class="flex flex-wrap gap-2">
              ...
              <strong>Intergenerational Dialogue:</strong> We organize
              conferences that bring together experienced mentors and young
              people to learn from each other's perspectives.
            </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <strong>Knowledge Sharing:</strong> Established professionals
              share their knowledge and experiences, equipping young people with
              valuable personal and professional development insights.
            </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <strong>Mentorship Opportunities:</strong> The Conversation
              Initiative facilitates connections between young people and
              potential mentors, fostering long-term guidance and support.
            </li>
          </ul>
        </div>
      </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Empowering Youth:</strong> Our inaugural teenagers'
                conference attracted over 100 secondary school students in
                Lagos, providing them with valuable learning opportunities and
          ...
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Building a Brighter Future:</strong> By bridging the
                generational gap, we empower young people to reach their full
      ...
      <section class="flex flex-col items-center bg-miscellanous py-16">
        <div class="text-center w-full h-96 space-y-6">
          ...
          >
            Join us in fostering impactful conversations.
          </h2>
