      ...
      <section class="bg-white py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex gap-3 items-center mb-2">
            Our initiative >
            <p class="text-primary capitalize">adopt a community</p>
          </div>
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              <h1
                class="md:text-5xl lg:text-[3.5rem] text-3xl mb-6 font-playfair font-neduim leading-normal"
              >
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <ul class="custom-bullet-list">
            ...
            <li>
              ...
              </span>Holistic Approach:</strong> We tackle a range of issues
              through our programs, including:
              <ul class="list-disc pl-5 space-y-3 mt-3 ml-6">
                <li>
                  Menstrual Hygiene & Safe Sex Education: We raise awareness and
                  provide essential resources to promote sexual and reproductive
                  health (SRH).
                </li>
                <li>
                  Gender-Based Violence Awareness: We empower individuals to
                  identify and address gender-based violence, promoting safety
                  and equality.
                </li>
                <li>
                  Livelihood Skills Development: We offer vocational training
                  and skill-building programs to enhance economic opportunities
                  for community members.
                </li>
                <li>
                  Community Empowerment: We foster a sense of ownership and
          ...
          <div class="mt-8">
            ...
            <ul class="custom-bullet-list">
              <li>
                ...
                Menstrual Hygiene:</strong> The Adopt, a Community
                Initiative, successfully delivered six sensitization programs on
                menstrual hygiene and safe sex in the slums of the Ifesowapo
                Community, Lagos. We have provided over 600 sanitary towels to
                100 girls and women.
              </li>
              <li>
                 <strong class="flex gap-2 mb-2">
                       <span class="mt-1">
                        ...
                        </span>Safe Sex Promotion:</strong> We have provided over 4,000
                condoms to 400 community members and 80 sex workers, promoting
                safer sex practices and public health.
              </li>
              <li>
                 <strong class="flex gap-2 mb-2">
                       <span class="mt-1">
                        ...
                        </span>Building a Sustainable Future:</strong> We empowered
                community members to advocate for change, promoting a ripple
                effect of positive social transformation.
              </li>
            </ul>
