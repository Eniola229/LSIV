   ...
   <!----First section--->
      <section class="bg-[#FFDED0]">
        ...
        >
          ...
          <div class="md:w-4/5">
            <h1
              class="md:text-5xl text-4xl md:leading-[3.2rem] capitalize text-accentTextDark font-playfair font-[500]"
            >
              building bridges for change: program design & implementation
            </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              ...
              <p
                class="mt-4 text-gray-700 md:w-3/4 mx-auto text-center text-xl leading-[2.1rem]"
              >
          ...
          <div class="mt-20 w-full">
            ...
            <div class="grid font-opensans md:grid-cols-3 grid-cols-1 gap-4">
              ...
              >
                ...
                >
                  <h3
                    class="capitalize font-semibold text-left md:leading-[2.72375rem] text-xl md:text-2xl"
                  >
                    Advocacy Programs
                  </h3>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <div class="mt-20 w-full">
            ...
            <div class="grid font-opensans md:grid-cols-2 grid-cols-1 gap-4">
              ...
              <!-- disscuss 2-->
              <div
                class="border-b bg-miscellanous p-6 rounded-lg transition-[all] duration-700"
              >
                <div
                  class="text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
      ...
      <section class="flex flex-col items-center bg-miscellanous py-16">
        <div class="text-center w-full h-96">
          <h2
            class="text-3xl md:text-5xl lg:text-[4rem] font-semibold mb-4 font-playfair md:w-4/5 mx-auto"
          >
