      ...
      <section class="bg-white py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div class="flex gap-3 items-center mb-2">
            Our initiative >
            <p class="text-primary capitalize">the lolo cynthia show</p>
          </div>
          <div class="flex flex-col lg:flex-col justify-between gap-4">
            <div class="w-full">
              <h1
                class="md:text-5xl capitalize lg:text-[3.5rem] text-3xl mb-6 font-playfair font-semibold leading-normal"
              >
      ...
      <section class="bg-secondary py-16 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <ul class="custom-bullet-list">
            <li class="flex items-start flex-wrap gap-2">
              <span class="mt-1">
              ...
              <div>
                <strong>Human-Centered Stories:</strong> We showcase real-life stories that resonate with viewers, tackling critical issues like:
          ...
          <li class="flex flex-wrap gap-2">
              ...
              <strong>Engaging Format:</strong> The show combines interviews,
              documentaries, animations, and re-enactments to create an
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Pilot Season Success:</strong> Our pilot season tackled
                sensitive issues like addiction, Down syndrome, HIV, and
                domestic abuse, receiving positive feedback for its authenticity
                and impact.
              </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Global Reach:</strong> We've curated stories from over
                45 people across six African countries, with a growing online
                community in the USA, India, Africa, and the UK.
              </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <strong>Inspiring Action:</strong> The show's influence extends
                beyond viewership.
                <ul class="list-disc pl-5 mt-3 space-y-3 ml-5">
                  <li>
                    The Leratong Joy for One orphanage featured in our
                    documentary received a 10,000 South African Rands donation,
                    a radio feature, and an award for community work.
                  </li>
                  <li>
                    Our episodes—Widows Plights and Child-Free Women—were used
                    as conversation starters on South Africa's popular radio
                    show, On the Move.
                  </li>
                  <li>
                    Our episode on child-free African women is featured on the
                    First Lady of Ondo State, Nigeria, women empowerment panel.
                  </li>
                  <li>
                    Leading Nigerian gynaecologists use the animation from our
                    PCOS episode as explainer videos for their patients.
                  </li>
                </ul>
              </li>
          <li class="flex flex-wrap gap-2">
               <span class="mt-1">
                ...
                <strong>Creating a Safe Space:</strong> We provide a platform
                for personal stories, empowering individuals to share their
                experiences and break down stigma. For instance:
                <ul class="list-disc pl-5 mt-3 space-y-3 ml-5">
                  <li>
                    Mothers in Kenya and Nigeria openly discussed the realities
                    of raising children with Down syndrome to create awareness
                    of Down syndrome family support groups and early therapy
                    interventions.
                  </li>
                  <li>
                    A young Nigerian man disclosed his HIV status for the first
                    time to his family on the show to challenge the narrative of
                    HIV as a killer and introduce the HIV medications ARVs and
                    PREP to the public.
                  </li>
                  <li>
                    Prominent feminists from Haiti, South Africa, and Nigeria
                    share their domestic abuse stories to create awareness of
                    available domestic shelters and early signs of abuse.
                  </li>
                </ul>
              </li>
            </ul>
