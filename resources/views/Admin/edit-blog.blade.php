        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="form-card p-4">
                    ...
                    @endif
                    <form action="{{ route('posts.create') }}" method="POST" enctype="multipart/form-data" class="border">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" value="{{ $blog->title }}" class="form-control border" id="title" name="title" placeholder="Enter post title" required>
                        </div>

                        <!-- Sub Title Field -->
                        <div class="form-group mb-4">
                            <label for="title" class="font-weight-bold">Client Name</label>
                            <input type="text" value="{{ $blog->sub_title }}" class="form-control border" id="sub_title" name="sub_title" placeholder="Enter client name" required>
                        </div>

                          <!-- Project Timeline -->
                        <div class="form-group mb-4">
                            <label for="title" class="font-weight-bold">Project Timeline</label>
                            <input type="text" value="{{ $blog->project_timeline }}" class="form-control border" id="project_timeline" name="project_timeline" placeholder="Enter sub title" required>
                        </div>

                         <!--  Our Service -->
                        <div class="form-group mb-4">
                            <label for="title" class="font-weight-bold"> Our Service</label>
                            <input type="text" value="{{ $blog->our_service }}" class="form-control border" id=" our_service" name=" our_service" placeholder="Enter sub title" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" name="content" rows="12" placeholder="Write your content here...">{{ $blog->content }}</textarea>
                        </div>

                        <!-- Submit Button -->
                        <div class="text-right mt-2">
                            <button type="submit" class="btn btn-primary btn-lg">Edit Case</button>
                        </div>
                    </form>
                </div>
            </div>
