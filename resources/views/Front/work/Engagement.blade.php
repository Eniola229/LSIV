  ...
  <!----First section--->
      <section class="bg-[#FFE4BB]">
        ...
        >
          ...
          <div class="md:w-4/5">
            <h1
              class="md:text-5xl capitalize text-4xl md:leading-[3.2rem] text-accentTextDark font-playfair font-[500]"
            >
              cultivating connections: our engagement events
            </h1>
            <p class="mt-4 text-gray-700 md:w-3/4 text-xl leading-[2.1rem]">
              <strong class="italic">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          <div class="mt-20 w-full">
            ...
            <div class="grid font-opensans md:grid-cols-2 grid-cols-1 gap-4">
              ...
              <!-- disscuss 3 -->
              <div
                class="border-b bg-secondary p-6 rounded-lg transition-[all] duration-700 md:w-1/2 mx-auto md:col-span-2"
              >
                <div
                  class="text-accentTextDark flex justify-between items-center gap-4 cursor-pointer"
                >
      ...
      <section class="flex flex-col items-center bg-miscellanous py-16">
        <div class="text-center w-full h-96">
          ...
          >
            We don’t just tell stories We drive change
          </h2>
