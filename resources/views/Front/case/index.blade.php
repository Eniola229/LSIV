     ...
     <main>
            ...
            <div class="lg:w-2/3 md:p-12">
              <div>
                <div class="flex gap-3 items-center mb-2">
                  Case Study >
                  <p class="text-primary">{{ $blog->sub_title }}:</p>
                </div>
                <h1
      ...
      <section class="bg-white py-12 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          ...
          >
            <!-- descrition -->
            <div class="lg:col-span-2 w-full lg:w-4/5 md">
          {!! $blog->content !!}
            </div>
            <!-- client-information -->
            <div
            ...
            >
              <div class="divide-y-2 divide-[#353535] px-6 font-opensans">
                ...
                <div class="flex-1 py-4">
                  ...
                  <p>{{ $blog->project_timeline }}</p>
                </div>
                <div class="flex-1 py-4">
                  <h3 class="text-lg font-semibold">Our Service</h3>
                  <p>{{ $blog->our_service }}</p>
                </div>
                <div class="py-4">
          ...
          <!-- pagination button -->
          <div
            class="flex justify-center flex-wrap items-center mt-24 gap-4 md:gap-3"
          >
            <button
            ...
            <div class="flex space-x-4">
              <!-- Case study numbers -->
              <button class="bg-primary text-white py-2 px-4 rounded-full">
                1
              </button>
              <button
