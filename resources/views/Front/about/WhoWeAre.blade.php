...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center justify-between">
                ...
                <div class="lg:w-2/3 lg:pl-10">
                	<h1 class="text-6xl font-serif font-bold text-dark-900 text-left md:text-left mb-16" style="font-family: 'Playfair Display', serif;">Lolo Social Impact Venture is a dedicated force for positive change.</h1>
                    <p class="text-dark-700 mb-6 font-normal text-xl">
     ...
     <section class="py-16 rounded bg-[#ECECD5]" style="background: #ECECD5;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                <!-- Text Section -->
                <div class="lg:w-2/3 lg:pl-10">
                	<h1 class="text-6xl font-serif font-bold text-dark-900 text-left md:text-left mb-16" style="font-family: 'Playfair Display', serif;">We connect grassroots voices with powerful platforms.</h1>
                    <p class="text-dark-700 mb-6 font-normal text-xl pr-px">
    ...
    <div class="bg-gray-100 py-8 px-4">
        ...
        <div class="max-w-7xl mx-auto text-center mb-4">
            <h2 class="text-6xl font-serif font-bold text-dark-900 text-left md:text-left" style="font-family: 'Playfair Display', serif;">Behind the Scenes</h2>
            <div class="flex font-semibold justify-end text-dark-500">
                <span>Scroll →</span>
            </div>
        </div>
    ...
    <section class="p-8 mt-12">
        <div class="grid md:grid-cols-2 gap-6">
            <!-- Vision -->
            <div class="bg-[#FFC6DB] p-6 rounded-lg shadow-lg h-72">
                 <h2 class="text-4xl font-serif font-bold text-dark-900 text-left md:text-left mb-6" style="font-family: 'Playfair Display', serif;">Our Vision</h2>
            ...
            <!-- Mission -->
            <div class="bg-[#FFDED0] p-6 rounded-lg shadow-lg">
            	 <h2 class="text-4xl font-serif font-bold text-dark-900 text-left md:text-left mb-6" style="font-family: 'Playfair Display', serif;">Our Mission</h2>
                <p class="text-dark-400 font-semibold mt-4">Our mission is to support our partners in driving positive social change through strategic advocacy, effective communication, and community-centered approaches. We aim to empower communities, amplify marginalized voices, and create lasting impact by fostering collaboration and leveraging innovative solutions to address the world's most pressing challenges.</p>
            </div>
        </div>
    </section>
    ...
    <section class="p-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div class="p-6 rounded-lg">
               <h2 class="text-6xl font-serif font-bold text-dark-900 text-left md:text-left mb-6 w-40" style="font-family: 'Playfair Display', serif;">What Makes Us Unique?</h2>
            </div>

            <!-- Deep-rooted Expertise -->
           <div class="bg-[#C4E1A4] p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
			    <h3 class="text-3xl font-semibold mb-4">Deep-rooted Expertise</h3>
			    <p class="mt-auto">Our team possesses in-depth knowledge of the subject matters we advocate for, allowing us to develop more targeted and impactful campaigns.</p>
			</div>

			 <!-- Collaborative Approach -->
           <div class="bg-[#ECECD5] p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
			    <h3 class="text-3xl font-semibold mb-4">Collaborative Approach</h3>
			    <p class="mt-auto">We engage deeply with communities, understanding their needs and amplifying their stories through innovative digital strategies.</p>
			</div>
			 <!-- Global Impact -->
           <div class="bg-[#FFDED0] p-6 rounded-lg shadow-lg flex flex-col justify-between h-80">
			    <h3 class="text-3xl font-semibold mb-4">Global Impact</h3>
			    <p class="mt-auto">Our ability to translate local insights into global action sets us apart. We form strategic partnerships across sectors to foster sustainable solutions to complex social issues.</p>
			</div>
			<!-- Results-Driven -->
           <div class="bg-[#DDC2FF] p-6 rounded-lg shadow-lg flex flex-col justify-between h-80">
			    <h3 class="text-3xl font-semibold mb-4">Results-Driven</h3>
			    <p class="mt-auto">Our ability to translate local insights into global action sets us apart. We form strategic partnerships across sectors to foster sustainable solutions to complex social issues.</p>
			</div>
									 <!-- Global Impact -->
           <div class="bg-[#FFE4BB] p-6 rounded-lg shadow-lg flex flex-col justify-between h-80">
			    <h3 class="text-3xl font-semibold mb-4">Holistic Approach</h3>
			    <p class="mt-auto">We integrate education, advocacy, and storytelling to help our clients communicate their impact in ways that inspire and mobilize.</p>
			</div>
        </div>
    </section>

    <div class="bg-[#C4E1Ad] py-10">
      <h1 class="text-center text-6xl font-bold" style="font-family: 'Playfair Display', serif;">Meet The Team</h1>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-24">
        ...
        <div class="bg-white rounded-xl p-6 text-center shadow-md w-72">
          ...
          <h2 class="text-xl font-semibold">Lolo Cynthia</h2>
          <p class="text-gray-600 mb-4 mt-4">CEO</p>
          <a href="#" class="inline-block mt-4 text-black">
        ...
        <div class="bg-white rounded-xl p-6 text-center shadow-md w-72">
          ...
          <h2 class="text-xl font-semibold">Akogun Elizabeth</h2>
        ...
        <div class="bg-white rounded-xl p-6 text-center shadow-md w-72">
          ...
          <h2 class="text-xl font-semibold">Team member name</h2>
          ...
          <a href="#" class="inline-block mt-4 text-black">
            <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-8 19h-3v-8h3v8zm-1.5-9.268c-.966 0-1.75-.797-1.75-1.732s.784-1.732 1.75-1.732 1.75.797 1.75 1.732-.784 1.732-1.75 1.732zm10.5 9.268h-3v-4.604c0-1.109-.026-2.536-1.548-2.536-1.548 0-1.786 1.211-1.786 2.462v4.678h-3v-8h2.878v1.094h.041c.401-.761 1.381-1.562 2.844-1.562 3.042 0 3.603 2.003 3.603 4.609v3.859z"/>
                    ...
                    <h1 class="text-6xl font-serif font-bold text-gray-900 text-left mb-12" style="font-family: 'Playfair Display', serif;">Our Impact in Action</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                         <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">Stories of Girls' Resistance</h2>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">The TY Danjuma Foundation</h2>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">Women's Crisis Center (WCC), Imo State</h2>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">Benmore Foundation & First Lady, Ondo State Government</h2>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">Orphans in South Africa Documentary</h2>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden w-full relative group">
                            ...
                            <div class="p-4">
                                <h2 class="font-semibold text-2xl">Inuadada Foundation</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-8" style="background: #ECECD5;">
            <div class="max-w-7xl h-80 mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 class="text-6xl font-serif font-bold text-gray-900 text-left mb-14" style="font-family: 'Playfair Display', serif;">Our clients & partners</h1>
